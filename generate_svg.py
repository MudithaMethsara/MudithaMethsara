...
svg_content = f'''<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 960 520" width="100%" height="100%">
  <defs>
    <style>
      ...
      .float-card {{ fill: #14151B; stroke: rgba(255, 255, 255, 0.12); stroke-width: 1; rx: 10px; }}
      .float-sub {{ font-family: 'Instrument Sans', sans-serif; font-size: 9.5px; font-weight: 500; fill: #8A8E9B; text-transform: uppercase; letter-spacing: 0.5px; }}
      .float-title {{ font-family: 'Instrument Sans', sans-serif; font-size: 12.5px; font-weight: 600; fill: #FFFFFF; }}
      .float-desc {{ font-family: 'Instrument Sans', sans-serif; font-size: 10px; font-weight: 400; fill: #94979E; }}
  ...
  <g clip-path="url(#heroCardClip)">
    ...
    <g transform="translate(630, 310)" filter="url(#floatShadow)">
      <rect width="230" height="96" rx="10" class="float-card" />
      
      <!-- Sub-label -->
      <text x="16" y="24" class="float-sub">Select project</text>
      
      <!-- Title with pulsing green status dot -->
      <g transform="translate(16, 44)">
        <circle cx="4" cy="-4" r="3.2" fill="#83CA16">
          <animate attributeName="opacity" values="1;0.4;1" dur="2s" repeatCount="indefinite" />
        </circle>
        <text x="14" y="0" class="float-title">Available for projects</text>
      </g>
      
      <!-- Description -->
      <text x="16" y="65" class="float-desc">Share a few details, and I'll get back</text>
      <text x="16" y="80" class="float-desc">with a clear direction.</text>
    </g>
